...
Decisions apply in order. Later ADRs refine earlier ones; they do not contradict.

| ID | Title | Status |
|---|---|---|
| [ADR-001](001-tech-stack.md) | Tech Stack | Accepted |
| [ADR-002](002-architecture.md) | SOLID + Functional Core / Imperative Shell | Accepted |
| [ADR-003](003-tdd.md) | Red-Green TDD | Accepted |
